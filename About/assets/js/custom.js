(function ($) {
    ...
    // Count Time JS
    function makeTimer() {
        var endTime = new Date("December 30, 2027 17:00:00 PDT");
    ...
    /* Start "Government Cyber Defense", "Cyber Training And Awareness" & "AI Powered Security" Demo JS
	==============================================================*/
    ...
    /* End "Government Cyber Defense", "Cyber Training And Awareness" & "AI Powered Security" Demo JS
	==============================================================*/

    /* Start "Cryptocurrency Security", "Finance & Fin Tech Security" & "Space Security" Demo JS
	===========================================================================================*/

    // Cryptocurrency Security Partner JS
    var SwiperTraveler = new Swiper(".cryptocurrency-security-partner-slider", {
        loop: true,
        spaceBetween: 25,
        autoplay: {
            delay: 2000,
    ...
    // Cryptocurrency Security Feedback Slider JS
    var SwiperTraveler = new Swiper(".cryptocurrency-security-feedback-slider", {
        loop: true,
        spaceBetween: 25,
        autoplay: {
            delay: 5000,
        ...
        pagination: {
            el: ".cryptocurrency-security-feedback-pagination",
            clickable: true,
        },
        breakpoints: {
            0: {
    ...
    // Finance Partner JS
    var SwiperTraveler = new Swiper(".finance-partner-slider", {
        loop: true,
        spaceBetween: 50,
        autoplay: {
            delay: 2000,
    ...
    // Space Partner JS
    var SwiperTraveler = new Swiper(".space-partner-slider", {
        loop: true,
        spaceBetween: 25,
        autoplay: {
            delay: 2000,
    ...
    // Space Solutions JS
    var SwiperTraveler = new Swiper(".space-solutions-slider", {
        loop: true,
        spaceBetween: 25,
        autoplay: {
            delay: 7000,
    ...
    //  Space Testimonials Slider JS
    var SwiperTraveler = new Swiper(".space-testimonials-slider", {
        loop: true,
        spaceBetween: 25,
        autoplay: {
            delay: 5000,
    ...
    /* End "Cryptocurrency Security", "Finance & Fin Tech Security" & "Space Security" Demo JS
	=========================================================================================*/
